...
namespace DateMate.API.Controllers
{
    ...
    public class PhotosController: ControllerBase
    {
        ...
        public PhotosController(IDateMateRepository repo, IMapper mapper, IOptions<CloudinarySettings> cloudinaryConfig)
        {
            _repo = repo;
            _mapper = mapper;
        ...
        public async Task<IActionResult> SetMainPhoto(int userId, int id)
        {
            ...
            var currentMainPhotoFromRepo = await _repo.GetMainPhotoForUser(userId);
            currentMainPhotoFromRepo.IsMain = false;
